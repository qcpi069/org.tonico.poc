#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : RPS_KSDY8000_KS_8010J_load_kszd001j_pos_ql.ksh
# Title         : Import POS claims from QL into Datamart
#
...
SCRIPT=RPS_KSDY8000_KS_8010J_load_kszd001j_pos_ql
...
#################################################################
FTP_TRIG_NAME=$MFJOB.posftp.ql.tlr
FTP_DATA_NAME=$MFJOB.posftp.ql.dat
