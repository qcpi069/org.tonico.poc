#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : RPS_KSDY8000_KS_8030J_load_kszd001j_pos_medst.ksh
# Title         : Import POS claims from State to Plan into Datamart
#
...
SCRIPT=RPS_KSDY8000_KS_8030J_load_kszd001j_pos_medst
...
#################################################################
FTP_TRIG_NAME=$MFJOB.medst2pl.tlr
FTP_DATA_NAME=$MFJOB.medst2pl.dat
