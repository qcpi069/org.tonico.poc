#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : RPS_KSDY7000_KS_7700J_daily_posting2.ksh
...
SCRIPT=RPS_KSDY7000_KS_7700J_daily_posting2 
JOB=ks7700j
...
#
# remove trigger file to prevent multiple process running
#
rm -f $INPUT_PATH/KS7700.ready
