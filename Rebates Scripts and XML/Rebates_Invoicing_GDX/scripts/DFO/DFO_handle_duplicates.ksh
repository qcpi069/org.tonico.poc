...
#
REPORT_FILE="$CLIENT_DIR/rejected/$UNIQUE_RUN_ID.duplicates"
...
#
#             FTP the file of duplicates to the Client.  Then delete temp file.
#             This logic has been commented out because the client no longer
#             wants to receive an ftp-ed file
#
#          echo "FTP'ing data in duplicates file to $CLIENT_NAME via prodftp(ecommerce)"  >> $LOG_FILE
#           cp $REPORT_FILE $CLIENT_DIR/rejected_files.txt
#           $SCRIPT_DIR/DFO_ftp_to_prodftp.ksh rejected_files.txt $CLIENT_DIR
#           rm $CLIENT_DIR/rejected_files.txt
...
#             "concerns by emailing William.Price@Caremark.com "        \
#             "\n\n\n"                                                  \
