...
#===================================================================
  echo "clean up crteload .good records ..... " >> $LOG_FILE
  rm $TEMP_DATA_DIR/*.crteload.good*
  SCRIPT_NAME=`basename $0`
  RETURN_CODE=$?
...
#===================================================================
  echo "clean up crteload .load records ..... " >> $LOG_FILE
  rm $TEMP_DATA_DIR/*.crteload.load.*
  SCRIPT_NAME=`basename $0`
  RETURN_CODE=$?
