...
echo "Sorting claims records by NDC ID/FILL DATE.."
...
#===================================================================
  ...
  if [[ ! -f "$IN_DATA_FILE" ]] then
     ...
     echo "Script: 'DFO_sortby_ndc.ksh'"                    \
...
#===================================================================
  ...
  sort -t"^" -T /GDX/prod/tmp -k1.42,1.60 -k1.34,1.41 $IN_DATA_FILE -o $OUT_DATA_FILE
  
  if [[ $? != 0 ]] then
  
     MAIL_SUBJECT="DFO SCRIPT EXECUTION ERROR"
     echo "DFO script 'DFO_sortby_ndc.ksh'"  \
          "\nProcessing for $CLIENT_NAME"    \
