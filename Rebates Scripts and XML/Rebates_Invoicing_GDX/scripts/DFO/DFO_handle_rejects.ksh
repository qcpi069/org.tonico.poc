...
#  export PROCESS_MONTH=aug
#  export REF_DIR="$HOME_DIR/control/reffile"
#  export TEMP_DIR="/vradfo/test/temp/T20030902083003_P63746"
...
#  export CLIENT_DIR="/vradfo/test/clients/FIRSTHEALTH"
#   export DATA_LOAD_FILE="dfo.vrap.tclaim_ext.dat.20030804172557"
#  export SCRIPT_DIR="$HOME_DIR/script"
#  export TEMP_DATA_DIR="/vradfo/test/temp/T20030902083003_P63746/dat"
#  export UNIQUE_RUN_ID="T20030902083003_P63746"
...
#  db2 "connect to udbmdap user " $CHESTER_USER " using " $CHESTER_PASSWORD" >/dev/null 2>/dev/null
  ...
  db2 "select 'inserted', ',' ,(inserted - deleted), ',' ,deleted from dba.loads where data_file = '$DBA_DATA_LOAD_DIR/$DATA_LOAD_FILE'"> $DB_2_LOG 2>>$LOG_FILE
...
#       during the conversion process.  Add the following:
        ...
        echo "Hello,\n\nDFO claims intake processing for $CLIENT_NAME for" \
             ...
             "\n\nPlease feel free to contact either Dennis Render x6250"  \
             "or William Price x6422 with any issues/questions/requests"   \
