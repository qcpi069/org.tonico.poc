...
echo "VALIDATION-III PROCESS BEGINS - `date +'%b %d, %Y %H:%M:%S'`......."
echo "Validing claims record fields.."
...
print  "DB PW is  " $DBPSWD				>> $LOG_FILE
  ...
  ICCON="$CONTRACT_FILE"
  OBADCLT="$OBADCLT_FILE"
 
  export ICLMS IREJC IPRCMTH IEREF OCLMS OREJ OLOG OREJC ICCON OBADCLT

  $EXE_DIR/validat2 >> $LOG_FILE
##  /vradfo/prod/aix/aixexec/validat2 >> $LOG_FILE
...
#===================================================================
  ...
  $SCRIPT_DIR/DFO_check_client_error.ksh $SCRIPT_NAME $RETURN_CODE $OBADCLT
...
#===================================================================
  ...
  echo "Claims record fields were validated.."
  echo "Process Successful."
  echo "VALIDATION-III PROCESS ENDED - `date +'%b %d, %Y %H:%M:%S'`......."
