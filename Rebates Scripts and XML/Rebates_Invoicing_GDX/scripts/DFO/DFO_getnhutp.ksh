...
echo "VALIDATION-IV PROCESS BEGINS - `date +'%b %d, %Y %H:%M:%S'`......."
echo "Validating NDC ID to get NHU TYPE CODE and AWP PRICE.."
...
print  "DB PW is  " $DBPSWD				>> $LOG_FILE
  ...
  export ICLMS IREJC IEREF ICCON OCLMS OREJ OLOG OREJC

  $EXE_DIR/getnhut2 >> $LOG_FILE
##  /vradfo/prod/aix/aixexec/getnhut2 >> $LOG_FILE
...
#===================================================================
  ...
  echo "\nNDC ID was validated.."
  echo "Process Successful."
  echo "VALIDATION-IV PROCESS ENDED - `date +'%b %d, %Y %H:%M:%S'`......."
