...
#================================================
  ...
  .  /GDX/prod/scripts/QLclaims/MDA_prod_profile_integration >/dev/null 2>&1 
####  .  $SCRIPT_DIR/dbenv.ksh >/dev/null 2>&1
  .  $COMMON_SCRIPT_DIR/Common_GDX_Environment.ksh >/dev/null 2>&1
...
#                 Continue with main MDA_process
                  $SCRIPT_DIR/MDA_process_claims_integration.ksh $CLIENT_NAME >>$LOG_FILE 2>&1
