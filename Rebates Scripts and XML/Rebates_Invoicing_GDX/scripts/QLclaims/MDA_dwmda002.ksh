...
#===================================================================
  ...
  dd_IDATE="$BILLG_END_DT_OVERRIDE_FILE"
  dd_OVRA1="$LOAD_FILE"
  dd_OERR1="$ERROR_FILE"
  dd_ONRBT="$NON_REBATEABLE_CLAIMS"
  export dd_IVRA1 dd_IDATE dd_OVRA1 dd_OERR1 dd_ONRBT
   
  cobrun '$EXE_DIR/dwmda002.int' > $LOG_DIR/dwmda002.cbl.logging

  grep times $LOG_DIR/dwmda002.cbl.logging > $LOG_DIR/SBO_audit
