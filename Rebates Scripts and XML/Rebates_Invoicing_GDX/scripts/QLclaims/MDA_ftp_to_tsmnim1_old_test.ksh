...
echo "File is getting transferred to tsmnim1 testing old token ring...."
export HOME_DIR="/vracobol/prod"
export LOG_FILE="/vracobol/prod/log/ftp_testing_old.log"
export REF_DIR="$HOME_DIR/control/reffile"
CHESTER_PASSWORD_FILE="$REF_DIR/chester_password.ref"
export DATA_LOAD_DIR="$HOME_DIR/control/dataload"
export TEMP_DIR="/vracobol/prod/temp/testing"
export SCRIPT_DIR="$HOME_DIR/script"
export DBA_DATA_LOAD_DIR="/datar1"

export DATA_LOAD_FILE="network.test.fast"
##export DATA_LOAD_FILE="test.little.file"
