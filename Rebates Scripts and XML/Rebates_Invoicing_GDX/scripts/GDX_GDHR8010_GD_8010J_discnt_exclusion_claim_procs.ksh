#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : /GDX/prod/scripts/GDX_GDHR8010_GD_8010J_discnt_exclusion_claim_procs.ksh         
# Title         : Exclusion Claim Processing - Discount Model Rebate Report
#
# Description   : This script build exclusion sum claims for discount rebate 
#                 reports.                  
#
# Parameters    : None.
#                
...
SCHEDULE="GDHR8010"
JOB="GD_8010J"
FILE_BASE="GDX_"$SCHEDULE"_"$JOB"_discnt_exclusion_claim_procs"
...
print `date`      					>> $LOG_FILE
print '....Started executing ' $SCRIPTNAME		>> $LOG_FILE
print ' '						>> $LOG_FILE
...
then
    ...
    print ' '						>> $LOG_FILE
    print 'Defaulting values "D" & "R" to script.'	>> $LOG_FILE
    export MODEL='D'
    export RPTTYP='R'
else 
    export MODEL=$1
...
print ' '						>> $LOG_FILE
print `date`						>> $LOG_FILE
print '....Started executing Cobol Program'             >> $LOG_FILE
print ' '						>> $LOG_FILE
...
print '********************************************* '  >> $LOG_FILE
print `date`						>> $LOG_FILE
print '....Completed executing Cobol Program'		>> $LOG_FILE
print '********************************************* '	>> $LOG_FILE
print ' '						>> $LOG_FILE
...
###################################################################################
 if [[ $RETCODE != 0 ]] ; then
	...
	print 'COBOL program created log file is '  $OLOG	>> $LOG_FILE
	print ' '						>> $LOG_FILE
	print 'Sending email with the following parameters'	>> $LOG_FILE
  	print ' '						>> $LOG_FILE
