#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_procd_rpt_sql040.ksh   
# Title         
#
# Description   : This script is for reallocating contracts in the 
#                   accural Monthly table, TMKTSHR_PROCD_SUM by contract and report.
#                 ONLYNOMPRD
#
...
#                                 scripts.
# 01-17-2005 N. Tucker            Initial Creation.
#
#-------------------------------------------------------------------------#
#-------------------------------------------------------------------------#
...
INSERT INTO $SCHEMA_OWNER.TMKTSHR_PROCD_SUM
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_procd_rpt_sql040.ksh " >> $LOG_FILE
