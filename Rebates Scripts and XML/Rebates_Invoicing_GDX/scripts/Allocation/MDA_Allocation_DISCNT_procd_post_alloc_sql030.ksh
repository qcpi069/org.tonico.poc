#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_post_alloc_sql030.ksh   
# Title         
#
...
FROM 
 ...
 ,A.QUAL_UNITS             AS QUAL_UNITS
   FROM $SCHEMA_OWNER.TDISCNT_PROCD_SUM$MODEL A
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_post_alloc_sql030.ksh " >> $LOG_FILE
