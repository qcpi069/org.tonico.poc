#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_qtrly_bill_sql050.ksh   
# Title         
#
# Description   : This script builds the fifth sql for the Market Share
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_qtrly_bill_sql050.ksh " >> $LOG_FILE
