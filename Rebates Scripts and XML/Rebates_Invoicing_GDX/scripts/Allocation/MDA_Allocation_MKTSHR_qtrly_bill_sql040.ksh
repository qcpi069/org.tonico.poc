#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_qtrly_bill_sql040.ksh   
# Title         
#
# Description   : This script builds the fourth sql for the Market Share
...
--    DON'T OVERLAY THE ALREADY ADDED MONTHLY BILLED VALUES
      ...
      AND ( ('M' || PART1.NEW_PERIOD_MONTH || PART1.NEW_PERIOD_YEAR) ||
              ...
              (SELECT DISTINCT ( RTRIM(CHAR(MS1.PERIOD_ID))  ||
                       ...
                       FROM $SCHEMA_OWNER.TMKTSHR_BILLED_SUM MS1)
;
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_qtrly_bill_sql040.ksh " >> $LOG_FILE
