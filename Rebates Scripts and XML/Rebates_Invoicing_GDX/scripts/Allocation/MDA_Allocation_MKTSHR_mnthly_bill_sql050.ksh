#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_mnthly_bill_sql050.ksh   
# Title         
#
# Description   : This script builds the fith sql for Monthly billed 
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_mnthly_bill_sql050.ksh " >> $LOG_FILE
