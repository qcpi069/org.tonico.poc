#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_mnthly_post_alloc_sql030.ksh   
# Title         
#
# Description   : This script is post allocation validation sql for the  
#                   mnthly billed table, TMKTSHR_BILLED_SUM.
#
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_mnthly_post_alloc_sql030.ksh " >> $LOG_FILE
