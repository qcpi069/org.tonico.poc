#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDAALLOC_MM_0032J_DSCNT_Allocation_by_rpt_id.ksh 
...
SCHEDULEA="MDAALLOC"
JOBA="MM_0032J"
FILE_BASEA=$SCHEDULEA"_"$JOBA"_""DSCNT_Allocation_by_rpt_id_"$PERIOD_IDA"_"$CNTRCT_IDA"_"$RPT_IDA
...
DESC_TEXTA="32J $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
if [[ $DISCNT_RUN_MODE_CDA = 'ACCL' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0032JA_DSCNT_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0032JA_DSCNT_Allocation_by_rpt_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'MPRD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0032JB_DSCNT_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0032JB_DSCNT_Allocation_by_rpt_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'PROD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0032JC_DSCNT_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0032JC_DSCNT_Allocation_by_rpt_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $RETCODE = 0 ]]; then
   ...
   DESC_TEXTA="DSCT32J COMP $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
99EOFSQLTEXT99
   ...
   if [[ $RETCODE = '9999' ]]; then
    DESC_TEXTA="DSCT32J OOB $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   else
        DESC_TEXTA="E32JDSCT $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   fi     
   print "=========================================================" >> $LOG_FILEA
