#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDAALLOC_MM_0012JB_MKTSHR_Allocation_by_rpt_id.ksh 
...
SCRIPTNAMEB="MDAALLOC_MM_0012JB_MKTSHR_Allocation_by_rpt_id.ksh"
...
print `date`                                             >> $LOG_FILEA
   ...
   print "====================================================================" >> $LOG_FILEA
   print "Building SQL MDA_Allocation_MKTSHR_mnthly_rpt_sql010.ksh with PARMS: " >> $LOG_FILEA
   print $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER >> $LOG_FILEA
   print "====================================================================" >> $LOG_FILEA
   . $SCRIPT_PATH/MDA_Allocation_MKTSHR_mnthly_rpt_sql010.ksh $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER 
   print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql010.ksh ==START======" >> $LOG_FILEA
   db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
   SQLCODE=$?
   print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
   print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql010.ksh ==END======" >> $LOG_FILEA
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
         print "====================================================================" >> $LOG_FILEA
         print "Building SQL MDA_Allocation_MKTSHR_mnthly_rpt_sql011.ksh " >> $LOG_FILEA
         print "====================================================================" >> $LOG_FILEA
         . $SCRIPT_PATH/MDA_Allocation_MKTSHR_mnthly_rpt_sql011.ksh $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER 
         print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql011.ksh ==START======" >> $LOG_FILEA
         db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
         SQLCODE=$?
         print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
         print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql011.ksh ==END======" >> $LOG_FILEA
   fi
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
      print "====================================================================" >> $LOG_FILEA
      print "Building SQL MDA_Allocation_MKTSHR_procd_rpt_sql020.ksh " >> $LOG_FILEA
      print "====================================================================" >> $LOG_FILEA
      . $SCRIPT_PATH/MDA_Allocation_MKTSHR_procd_rpt_sql020.ksh $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER 
      print "======db2 MDA_Allocation_MKTSHR_procd_rpt_sql020.ksh ==START======" >> $LOG_FILEA
      db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
      SQLCODE=$?
      print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
      print "======db2 MDA_Allocation_MKTSHR_procd_rpt_sql020.ksh ==END======" >> $LOG_FILEA
   fi
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
         SQLCODE=0
         while [[ $SQLCODE = 0 ]]; do
   ...
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
      ...
      print "======db2 MDA_Allocation_MKTSHR_procd_sum_sql030.ksh ==START======" >> $LOG_FILEA
      db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
      SQLCODE=$?
      print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
      print "======db2 MDA_Allocation_MKTSHR_procd_sum_sql030.ksh ==END======" >> $LOG_FILEA
   fi         
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
      print "====================================================================" >> $LOG_FILEA
      print "Building SQL MDA_Allocation_MKTSHR_mnthly_rpt_sql040.ksh " >> $LOG_FILEA
      print "====================================================================" >> $LOG_FILEA
      . $SCRIPT_PATH/MDA_Allocation_MKTSHR_mnthly_rpt_sql040.ksh $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER 
      print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql040.ksh ==START======" >> $LOG_FILEA
      db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
      SQLCODE=$?
      print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
      print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql040.ksh ==END======" >> $LOG_FILEA
   fi
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
      print "====================================================================" >> $LOG_FILEA
      print "===CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC========" >> $LOG_FILEA
      print "Building SQL MDA_Allocation_MKTSHR_mnthly_rpt_sql050.ksh " >> $LOG_FILEA
      print "====================================================================" >> $LOG_FILEA
      . $SCRIPT_PATH/MDA_Allocation_MKTSHR_mnthly_rpt_sql050.ksh $SQL_FILE_NAMEA $LOG_FILEA $PERIOD_IDA $CNTRCT_IDA $RPT_IDA $SCHEMA_OWNER 
      print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql050.ksh ==START======" >> $LOG_FILEA
      db2 -stvxf $SQL_FILE_NAMEA >> $LOG_FILEA
      SQLCODE=$?
      print "SQLCODE is :" $SQLCODE >> $LOG_FILEA
      print "======db2 MDA_Allocation_MKTSHR_mnthly_rpt_sql050.ksh ==END======" >> $LOG_FILEA
   fi         
   if [[ $SQLCODE = 0 || $SQLCODE = 1 ]]; then
      RETCODE=0
   else   
