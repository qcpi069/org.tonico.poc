#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_mnthly_post_alloc_sql010.ksh   
# Title         
#
...
from    vrap.tmktshr_claim_sum a,
    (select distinct q.period_id, q.rpt_id as rpt, q.drug_ndc_id as ndc,
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_mnthly_post_alloc_sql010.ksh " >> $LOG_FILE
