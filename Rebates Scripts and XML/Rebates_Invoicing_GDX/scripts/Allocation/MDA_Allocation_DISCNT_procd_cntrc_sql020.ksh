#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_cntrc_sql020.ksh   
# Title         
#
# Description   : This script builds the sql for the 
#                   Accural Monthly table, TDISCNT_PROCD_SUM$MODEL.
#   
#
...
INSERT INTO $SCHEMA_OWNER.TDISCNT_PROCD_SUM$MODEL
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_cntrc_sql020.ksh " >> $LOG_FILE
