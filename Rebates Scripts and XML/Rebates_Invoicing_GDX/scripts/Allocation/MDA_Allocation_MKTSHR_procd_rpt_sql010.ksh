#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_procd_rpt_sql010.ksh   
# Title         
#
...
DELETE FROM $SCHEMA_OWNER.TMKTSHR_PROCD_SUM
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_procd_rpt_sql010.ksh " >> $LOG_FILE
