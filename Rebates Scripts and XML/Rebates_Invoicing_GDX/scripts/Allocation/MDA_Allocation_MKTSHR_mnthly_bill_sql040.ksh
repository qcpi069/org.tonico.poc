#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_mnthly_bill_sql040.ksh   
# Title         
#
# Description   : This script builds the fourth sql for the Monthly billed 
#                  table, TMKTSHR_BILLED_SUM.
#
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_mnthly_bill_sql040.ksh " >> $LOG_FILE
