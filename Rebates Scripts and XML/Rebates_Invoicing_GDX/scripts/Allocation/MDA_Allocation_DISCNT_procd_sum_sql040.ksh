#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_sum_sql040.ksh   
# Title         
#
# Description   : This script builds the sql for the Discount
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_sum_sql040.ksh " >> $LOG_FILE
