#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDAALLOC_MM_0031J_DSCNT_Allocation_by_cntrc_id.ksh 
...
SCHEDULEA="MDAALLOC"
JOBA="MM_0031J"
FILE_BASEA=$SCHEDULEA"_"$JOBA"_""DSCNT_Allocation_by_cntrc_id_"$PERIOD_IDA"_"$CNTRCT_IDA"_"$RPT_IDA
...
DESC_TEXTA="DSCT31J $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
if [[ $DISCNT_RUN_MODE_CDA = 'ACCL' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0031JA_DSCNT_Allocation_by_cntrc_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0031JA_DSCNT_Allocation_by_cntrc_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'MPRD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0031JB_DSCNT_Allocation_by_cntrc_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0031JB_DSCNT_Allocation_by_cntrc_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'PROD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0031JC_DSCNT_Allocation_by_cntrc_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0031JC_DSCNT_Allocation_by_cntrc_id.ksh $MODEL_TYP_CD
   RETCODE=$?
fi
...
if [[ $RETCODE = 0 ]]; then
   ...
   DESC_TEXTA="DSCT31J COMP $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
99EOFSQLTEXT99
   ...
   if [[ $RETCODE = '9999' ]]; then
    DESC_TEXTA="DSCT31J OOB $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   else
        DESC_TEXTA="E31JDSCT $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   fi     
   print "=========================================================" >> $LOG_FILEA
