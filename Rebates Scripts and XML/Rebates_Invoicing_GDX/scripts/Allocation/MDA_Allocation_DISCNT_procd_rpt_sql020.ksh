#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_rpt_sql020.ksh   
# Title         
#
# Description   : This script builds the sql for the 
#                   Accural Monthly table, TDISCNT_PROCD_SUM$MODEL, by rpt_id.
#                 ONLYACCL
#
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_rpt_sql020.ksh " >> $LOG_FILE
