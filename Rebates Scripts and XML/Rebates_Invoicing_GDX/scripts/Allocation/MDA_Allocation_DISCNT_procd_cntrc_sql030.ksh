#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_cntrc_sql030.ksh   
# Title         
#
...
UPDATE $SCHEMA_OWNER.TDISCNT_PROCD_SUM$MODEL
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_cntrc_sql030.ksh " >> $LOG_FILE
