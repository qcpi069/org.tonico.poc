#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_pre_allocation_sql020.ksh   
# Title         
#
...
print "============================================================================= "  >> $LOG_FILE
print "Starting build of SQL for MDA_Allocation_DISCNT_pre_allocation_sql020"  >> $LOG_FILE
print `date` >> $LOG_FILE
...
FROM 
    ...
    WHERE NOT EXISTS 
         ...
         (SELECT 1
            FROM VRAP.TDISCNT_EXT_CLAIM$MODEL  B   
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_pre_allocation_sql020.ksh " >> $LOG_FILE
    print "Return Code is :  " $RETCODE >> $LOG_FILE
    print `date` >> $LOG_FILE
else    
    print " " >> $LOG_FILE
    print "....Completed building of SQL for MDA_Allocation_DISCNT_pre_allocation_sql020.ksh"   >> $LOG_FILE
