#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_pre_allocation_sql030.ksh   
# Title         
#
...
print "============================================================================= "  >> $LOG_FILE
print "Starting build of SQL for MDA_Allocation_MKTSHR_pre_allocation_sql030"  >> $LOG_FILE
print `date` >> $LOG_FILE
...
SELECT         B.CNTRCT_ID
  ...
  FROM VRAP.TDISCNT_CLAIM_SUM$MODEL  B
      ,(SELECT  CNTRCT_ID
          ...
          FROM  VRAP.TDISCNT_EXT_CLAIM$MODEL
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_pre_allocation_sql030.ksh " >> $LOG_FILE
    print "Return Code is :  " $RETCODE >> $LOG_FILE
    print `date` >> $LOG_FILE
else    
    print " " >> $LOG_FILE
    print "....Completed building of SQL for MDA_Allocation_DISCNT_pre_allocation_sql030.ksh"   >> $LOG_FILE
