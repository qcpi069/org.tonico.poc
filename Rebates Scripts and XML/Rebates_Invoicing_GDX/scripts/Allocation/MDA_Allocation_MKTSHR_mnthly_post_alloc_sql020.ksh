#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_mnthly_post_alloc_sql020.ksh   
# Title         
#
...
#   Date                 Description
# ---------  ----------  -------------------------------------------------#
# 05-18-2005 J.Tedeschi  Added  AND A.DISCNT_RUN_MODE = 'MPRD'
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_mnthly_post_alloc_sql020.ksh " >> $LOG_FILE
