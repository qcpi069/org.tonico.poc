#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_mnthly_cntrc_sql040.ksh   
# Title         
#
# Description   : This script builds the sql discount monthly billed table,
#           TDISCNT_BILLED_SUM$MODEL by contract id.
#
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_mnthly_cntrc_sql040.ksh   " >> $LOG_FILE
