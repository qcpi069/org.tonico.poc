#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDAALLOC_MM_0012J_MKTSHR_Allocation_by_rpt_id.ksh 
...
SCHEDULEA="MDAALLOC"
JOBA="MM_0012J"
FILE_BASEA=$SCHEDULEA"_"$JOBA"_""MKTSHR_Allocation_by_rpt_id_"$PERIOD_IDA"_"$CNTRCT_IDA"_"$RPT_IDA
...
DESC_TEXTA="MKSH12J $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
if [[ $DISCNT_RUN_MODE_CDA = 'MKSH' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0012JA_MKTSHR_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0012JA_MKTSHR_Allocation_by_rpt_id.ksh 
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'MPRD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0012JB_MKTSHR_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0012JB_MKTSHR_Allocation_by_rpt_id.ksh 
   RETCODE=$?
fi
...
if [[ $DISCNT_RUN_MODE_CDA = 'PROD' ]]; then
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print "!!!!!! Running MDAALLOC_MM_0012JC_MKTSHR_Allocation_by_rpt_id.ksh" >> $LOG_FILEA
   print " " >> $LOG_FILEA
   print " " >> $LOG_FILEA
   . $SCRIPT_PATH/MDAALLOC_MM_0012JC_MKTSHR_Allocation_by_rpt_id.ksh 
   RETCODE=$?
fi
...
if [[ $RETCODE = 0 ]]; then
   ...
   DESC_TEXTA="MKSH12J COMP $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
...
99EOFSQLTEXT99
   ...
   if [[ $RETCODE = '9999' ]]; then
    DESC_TEXTA="MKSH12J OOB $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   else
        DESC_TEXTA="E12JMKSH $DISCNT_RUN_MODE_CDA C$CNTRCT_IDA R$RPT_IDA"
   fi     
   print "=========================================================" >> $LOG_FILEA
