#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_MKTSHR_pre_allocation_sql010.ksh   
# Title         
#
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_MKTSHR_pre_allocation_sql010.ksh " >> $LOG_FILE
    print "Return Code is :  " $RETCODE >> $LOG_FILE
    print `date` >> $LOG_FILE
else    
    print " " >> $LOG_FILE
    print "....Completed building of SQL for MDA_Allocation_MKTSHR_pre_allocation_sql010.ksh"   >> $LOG_FILE
