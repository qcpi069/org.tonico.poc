#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_create_dcl_pair_sql010.ksh   
# Title         
#
# Description   : This script is the first step of the process to creates
#               drug class pairs.
#                 
...
delete from VACTUATE.TMKTSHR_DCL_PAIR_TEMP;
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_create_dcl_pair_sql010.ksh " >> $LOG_FILE
