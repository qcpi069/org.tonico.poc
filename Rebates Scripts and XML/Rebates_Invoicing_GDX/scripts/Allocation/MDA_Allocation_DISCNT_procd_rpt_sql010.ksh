#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : MDA_Allocation_DISCNT_procd_rpt_sql010.ksh   
# Title         
#
...
DELETE FROM $SCHEMA_OWNER.TDISCNT_PROCD_SUM$MODEL
...
if [[ $RETCODE != 0 ]]; then
    ...
    print "script MDA_Allocation_DISCNT_procd_rpt_sql010.ksh " >> $LOG_FILE
