#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : rbate_KC_2327J_XMD_Crossover_Process.ksh   
# Title         : .
#
# Description   : Executes PK_XMD_Crossover_Driver to acquire the 
#                 XMD Crossover claims for claim processing within the 
#                 GDX system.
#                 
#                 
#                 
# Maestro Job   : KC_2327J
#
#   Date                 Description
# ---------  ----------  -------------------------------------------------#
# 06-22-07   is45401     Initial Creation, cloned from GPO crossover script
#
#-------------------------------------------------------------------------#
#-------------------------------------------------------------------------#
...
SCHEDULE=
JOB="KC_2327J"
FILE_BASE="rbate"$SCHEDULE"_"$JOB"_XMD_Crossover_Process"
...
Package_Name="dma_rbate2.pk_xmd_crossover_driver.prc_xmd_crossover_driver"
