...
SCHEDULE="KCMN1010"
JOB="KC_1020J"
FILE_BASE="rbate_"$SCHEDULE"_"$JOB"_Medicare_NCPDP_Creation_"$CYCLE_GID"_"$PICO_NO"_jobXXXX"$LOOPCTR
...
EOF
  ...
  if [[ $ORA_EMAIL_RETCODE != 0 ]]; then
    ...
    cut -c270,271,272,273,274,275,276,277,278,279,280,281,282,283,284,285,286,287 $OUTPUT_PATH/$DAT_FILE > $OUTPUT_PATH/$FILE_BASE'_TEMP_split13.dat'
    cut -c288 $OUTPUT_PATH/$DAT_FILE > $OUTPUT_PATH/$FILE_BASE'_TEMP_split14.dat'
