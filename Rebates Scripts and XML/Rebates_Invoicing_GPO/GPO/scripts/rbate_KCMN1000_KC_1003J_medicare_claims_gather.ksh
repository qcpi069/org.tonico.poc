...
#=====================================================================
#
# File Name    = rbate_KCMN1000_KC_1003J_medicare_claims_gather.ksh
# Description  = Execute the pk_gather_medicare_claims PL/SQL package
#
#==============================================================================
#                              CHANGE LOG
#==============================================================================
...
export JOB="KC_1003J"
export PKG_NAME=dma_rbate2.PK_GATHER_MEDICARE_CLAIMS.prc_get_medicare_claims
export SCHEDULE="KCMN1000"
export FILE_BASE="rbate_"$SCHEDULE"_"$JOB"_medicare_claims_gather"
...
PKG_EXEC=$PKG_NAME\(\'$BEGIN_DATE\'\,\'$END_DATE\'\,\'$CYCLE_GID\'\);
