...
#=====================================================================
#
# File Name    = rbate_KCMN1010_KC_1010J_medicare_refresh.ksh
# Description  = Execute the PK_MEDICARE_REFRESH_DRIVER.prc_medicare_refresh_driver
#		   PL/SQL package
#
#==============================================================================
#                              CHANGE LOG
...
export JOB="KC_1010J"
export PKG_NAME=dma_rbate2.PK_MEDICARE_REFRESH_DRIVER.prc_medicare_refresh_driver
export SCHEDULE="KCMN1010"
export FILE_BASE="rbate_"$SCHEDULE"_"$JOB"_medicare_refresh"
