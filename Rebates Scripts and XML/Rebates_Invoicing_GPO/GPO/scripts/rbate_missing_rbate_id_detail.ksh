#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : rbate_missing_rbate_id_detail.ksh  
...
export FILE_BASE="rbate_missing_rbate_id_detail"
export SCRIPTNAME="rbate_missing_rbate_id_detail.ksh"
export LOG_FILE="rbate_missing_rbate_id_detail.log"
export SQL_FILE="rbate_missing_rbate_id_detail.sql"
export DAT_FILE="rbate_missing_rbate_id_detail.dat"
export FTP_CMDS="rbate_missing_rbate_id_detail_ftpcommands.txt"
...
cat > $INPUT_PATH/rbate_missing_rbate_id_detail.sql << EOF
