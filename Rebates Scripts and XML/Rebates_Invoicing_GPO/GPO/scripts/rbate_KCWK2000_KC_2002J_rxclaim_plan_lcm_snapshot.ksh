#!/bin/ksh
#-------------------------------------------------------------------------#
# Script        : rbate_KCWK2000_KC_2002J_rxclaim_plan_lcm_snapshot.ksh   
# Title         : Snapshot refresh.
#
# Description   : Refreshes the dwcorp.mv_rxclaim_plan_lcm snapshot on Silver. 
#                
# Maestro Job   : KC_2002J
#
# Parameters    : None
#
...
SCHEDULE="KCWK2000"
JOB="KC_2002J"
FILE_BASE="rbate_"$SCHEDULE"_"$JOB"_rxclaim_plan_lcm_snapshot"
...
SET TIMING ON
exec DBMS_SNAPSHOT.REFRESH('DWCORP.mv_rxclaim_plan_lcm','C',atomic_refresh=>true);
EXIT
EOF

print " "                                                                    >> $OUTPUT_PATH/$LOG_FILE
print "================================================================="    >> $OUTPUT_PATH/$LOG_FILE
print " Now executing the DBMS_SNAPSHOT.REFRESH procedure on DWCORP.mv_rxclaim_plan_lcm" >> $OUTPUT_PATH/$LOG_FILE
print `date`                                                                 >> $OUTPUT_PATH/$LOG_FILE
print "================================================================="    >> $OUTPUT_PATH/$LOG_FILE
print " "                                                                    >> $OUTPUT_PATH/$LOG_FILE
