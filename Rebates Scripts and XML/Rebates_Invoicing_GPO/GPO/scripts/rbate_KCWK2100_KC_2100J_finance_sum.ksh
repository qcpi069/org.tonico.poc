...
#=====================================================================
#
# File Name    = rbate_KCWK2100_KC_2100J_finance_sum.ksh
# Description  = Execute the pk_finance_summary_tbl_driver PL/SQL package
#
#==============================================================================
#                              CHANGE LOG
#==============================================================================
...
#==============================================================================
#  08/06/03  is31701                 initial script creation
#==============================================================================
#----------------------------------
...
export JOB="KC_2100J"
export PKG_NAME=dma_rbate2.PK_FINANCE_SUMMARY_TBL_DRIVER.PRC_FINANCE_SUMMARY_TBL_DRIVER
export SCHEDULE="KCWK2100"
export FILE_BASE="rbate_"$SCHEDULE"_"$JOB"_finance_sum"
